//! Domain policy for DeliveryCarrier aggregate
//!
...
/// Domain policy for DeliveryCarrier — permits all operations (no business invariants).
///
...
/// enforcement, implement `backbone_core::ServiceLifecycle<DeliveryCarrier>` on a custom
/// service. `PermitAllPolicy` is the safe default until then.
pub type DeliveryCarrierDomainPolicy = PermitAllPolicy<DeliveryCarrier>;
