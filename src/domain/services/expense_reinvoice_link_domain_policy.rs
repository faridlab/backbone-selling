//! Domain policy for ExpenseReinvoiceLink aggregate
//!
...
/// Domain policy for ExpenseReinvoiceLink — permits all operations (no business invariants).
///
...
/// enforcement, implement `backbone_core::ServiceLifecycle<ExpenseReinvoiceLink>` on a custom
/// service. `PermitAllPolicy` is the safe default until then.
pub type ExpenseReinvoiceLinkDomainPolicy = PermitAllPolicy<ExpenseReinvoiceLink>;
