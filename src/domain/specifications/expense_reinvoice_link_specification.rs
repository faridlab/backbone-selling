//! Specifications for ExpenseReinvoiceLink aggregate
//!
...
// Each predicate implements `Specification<ExpenseReinvoiceLink>` and can be combined
...
//
// pub struct ActiveExpenseReinvoiceLinkSpec;
// impl Specification<ExpenseReinvoiceLink> for ActiveExpenseReinvoiceLinkSpec {
//     fn is_satisfied_by(&self, e: &ExpenseReinvoiceLink) -> bool {
//         // e.is_active
//         todo!()
//     }
// }
