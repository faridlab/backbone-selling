//! Specifications for QuotationItem aggregate
//!
...
// Each predicate implements `Specification<QuotationItem>` and can be combined
...
//
// pub struct ActiveQuotationItemSpec;
// impl Specification<QuotationItem> for ActiveQuotationItemSpec {
//     fn is_satisfied_by(&self, e: &QuotationItem) -> bool {
//         // e.is_active
//         todo!()
//     }
// }
