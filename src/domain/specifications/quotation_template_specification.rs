//! Specifications for QuotationTemplate aggregate
//!
...
// Each predicate implements `Specification<QuotationTemplate>` and can be combined
...
//
// pub struct ActiveQuotationTemplateSpec;
// impl Specification<QuotationTemplate> for ActiveQuotationTemplateSpec {
//     fn is_satisfied_by(&self, e: &QuotationTemplate) -> bool {
//         // e.is_active
//         todo!()
//     }
// }
