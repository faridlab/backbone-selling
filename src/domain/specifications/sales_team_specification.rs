//! Specifications for SalesTeam aggregate
//!
...
// Each predicate implements `Specification<SalesTeam>` and can be combined
...
//
// pub struct ActiveSalesTeamSpec;
// impl Specification<SalesTeam> for ActiveSalesTeamSpec {
//     fn is_satisfied_by(&self, e: &SalesTeam) -> bool {
//         // e.is_active
//         todo!()
//     }
// }
